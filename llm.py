...
#prompt engineering si quieres usar otro modelo  opnk jzbj zorb iczj
class LLM():
    def __init__(self):
        pass
    ...
    def process_functions(self, text):
        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                    ...
                    {"role": "system", "content": "Eres un asistente buena onda "},
                ...
                },
                {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "nombre": {
                                "type": "string",
                                "description": "el nombre del video que queremos decargar"
                            }
                        },
                        "required": ["nombre"]
                    }
                },
                {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "nombre": {
                                "type": "string",
                                "description": "el nombre del video  que queremos a descargar"
                            }
                        },
                        "required": ["nombre"]
                    }
                },
                {
                    ...
                    "description": "Apagar la computadora",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "segundos": {
                                "type": "string",
                                "description": "tiempo en segundos en que se debe apagar la pc"
                            }
                        },
                        "required": ["segundos"]
                    }
                },
                {
                    ...
                    "description": "Cancelar el apagado de la computadora",
                    "parameters": {
                        "type": "object",
                        "properties": {},
                        "required": []
                ...
                {
                    "name": "clean_system",
                    "description": "Realizar una limpieza del sistema",
                    "parameters": {
                        "type": "object",
                        "properties": {},
                        "required": []
                ...
                },
                {
                    ...
                    "description": "Organizar las carpetas en el directorio",
                    "parameters": {
                        "type": "object",
                        "properties": { },
                        "required": []
    ...
    def process_response(self, text, message, function_name, function_response):
        response = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "system", "content": "Eres un asistente  que aveces no le gusta obedecer"},
                {"role": "user", "content": text},
                message,
                {
                    "role": "function",
